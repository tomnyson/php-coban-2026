    ...
    <main class="py-5">
      <div class="container">
        ...
        <div class="card shadow-sm">
          <div class="card-body">
          <?php if (!empty($found)) {
            echo "<h5> Name:". htmlspecialchars($found['name']) ."</h5>";
            echo "<h5> Email: " . $found['email'] . "</h5>";
            echo "<h5> Role: " . $found['role'] . "</h5>";
            echo "<h5> Status: " . $found['status'] . "</h5>";
          }
          ?>
          </div>
        </div>
...
<?php } else {
  echo "<h1 style='color: red; text-align: center'>ko tim thay email </h1>";
}
?>